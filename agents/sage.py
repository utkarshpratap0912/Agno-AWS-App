...
#         storage=PostgresAgentStorage(table_name=f"{tenant_id}_sage_sessions" if tenant_id else "sage_sessions", db_url=db_url),
#         # Knowledge base for the agent
#         knowledge=AgentKnowledge(
#             vector_db=PgVector(table_name=f"{tenant_id}_sage_knowledge", schema="ai", db_url=db_url, search_type=SearchType.hybrid)
#         ),
